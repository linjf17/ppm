...
def make_board(size, num_rigid=0, num_wood=0):
    ...
    def make(size, num_rigid, num_wood):
        ...
        # board[3, 1] = constants.Item.Agent1.value
        # board[3, 3] = constants.Item.Agent2.value
        # board[1, 3] = constants.Item.Agent3.value
        # agents = [(1, 1), (3, 1), (3, 3), (1, 3)]
        

        # for i in range(5):
        #     board[4][i] = constants.Item.Rigid.value
        # for i in range(5):
        #     board[i][4] = constants.Item.Rigid.value
        ################################################################
